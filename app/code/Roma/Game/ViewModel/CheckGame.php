...
class CheckGame implements ArgumentInterface
{
     ...
     */
    public function __construct(GameRepositoryInterface $gameList,SearchCriteriaBuilder $searchCriteriaBuilder)
    {
    ...
    {
        $searchCriteria = $this->searchCriteriaBuilder->addFilter(GameInterface::GAME_ID, $id)->create();
